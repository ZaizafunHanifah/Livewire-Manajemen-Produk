{{-- filepath: resources/views/livewire/penjualan-dan-laporan.blade.php --}}
<div class="container mt-4">
    <h4>Penjualan & Laporan Harian</h4>
    <button class="btn btn-primary mb-2" wire:click="create">Input Penjualan</button>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <input type="date" wire:model="tanggal_laporan" class="form-control">
        </div>
    </div>
    <div class="alert alert-info">
        Total Nilai Penjualan Tanggal <b>{{ $tanggal_laporan }}</b>: <b>Rp {{ number_format($totalPenjualan,0,',','.') }}</b>
    </div>
